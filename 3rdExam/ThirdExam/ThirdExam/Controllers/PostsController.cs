...
namespace ThirdExam.Controllers
{
    ...
    {
        private ThirdExamMorningEntities db = new ThirdExamMorningEntities();
        ...
        public ActionResult Create([Bind(Include = "ID,AuthorID,CategoryID,SubCategoryID,PublishDate,Title,ShortDescription,Description,PostImage,Status,URL")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,AuthorID,CategoryID,SubCategoryID,PublishDate,Title,ShortDescription,Description,PostImage,Status,URL")] Post post)
        {
            if (ModelState.IsValid)
            {
